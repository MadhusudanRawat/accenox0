...
const Footer = () => {
  return (
    <footer className="bg-white pt-32 pb-16 px-6 sm:px-12 md:px-24 border-t border-border/40 overflow-hidden">
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="mt-8 text-xl text-muted font-medium leading-relaxed max-w-md">
            ...
            <div className="flex gap-4 mt-10">
              {[
                ...
                <Link
                  key={i}
                  href={href}
                  className="group w-12 h-12 rounded-2xl bg-primary/[0.03] border border-primary/5 flex items-center justify-center text-primary/40 hover:text-accent hover:border-accent/30 hover:bg-accent/[0.03] transition-all duration-300"
                >
          ...
          <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-12">
            ...
            <div className="space-y-8">
              <h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-primary/30">Contact</h4>
              <ul className="flex flex-col gap-4">
                <li>
                  <Link href="mailto:hello@accenox.com" className="text-primary/80 font-bold hover:text-accent transition-colors break-words">
                    hello@accenox.com
                  </Link>
                </li>
                <li className="text-primary/80 font-bold">
                  San Francisco, CA
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-8 col-span-2 sm:col-span-1">
              <h4 className="text-[11px] font-black uppercase tracking-[0.2em] text-primary/30">Legal</h4>
              <ul className="flex flex-col gap-4">
                {["Privacy", "Terms", "Cookies"].map(item => (
                  <li key={item}>
                    <Link href="#" className="text-primary/80 font-bold hover:text-accent transition-colors">
                      {item}
                    </Link>
                  </li>
                ))}
        ...
        <div className="mt-32 pt-12 border-t border-border/40 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-2 group cursor-default">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-primary/20 group-hover:text-primary/40 transition-colors">
              Systems Operational
            </span>
          </div>
        </div>
        ...
        <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 pointer-events-none select-none opacity-50">
          <span className="text-[18vw] font-black text-primary/[0.02] leading-none tracking-tighter">
            ACCENOX
          </span>
        </div>
      </div>
