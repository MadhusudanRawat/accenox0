  ...
  return (
    <footer className="bg-black pt-32 pb-16 px-6 sm:px-12 md:px-24 border-t border-white/5 overflow-hidden text-white">
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-[#00A3FF]/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
            ...
            <div className="flex gap-4 mt-10">
              {[
                ...
                <Link
                  key={i}
                  href={href}
                  className="group w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:border-white/30 hover:bg-white/10 transition-all duration-300"
                >
          ...
          <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-12">
            <div className="space-y-8">
              ...
              <ul className="flex flex-col gap-4">
                {["About", "Services", "Solutions", "Process", "Portfolio"].map(item => (
                  <li key={item}>
                    <Link href={item === "Portfolio" ? "/portfolio" : `/#${item.toLowerCase()}`} className="group flex items-center gap-1 text-white/80 font-bold hover:text-white transition-colors">
                      {item}
            ...
            <div className="space-y-8">
              ...
              <ul className="flex flex-col gap-4">
                <li>
                  <Link href="mailto:connect@accenox.com" className="text-white/80 font-bold hover:text-white transition-colors break-words">
                    connect@accenox.com
                  </Link>
                </li>
